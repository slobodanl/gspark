...
public class CassandraDemo implements Serializable {
    ...
    private void generateData(JavaSparkContext sc) {
        ...
        javaFunctions(productsRDD)
                .writerBuilder("java_api", "products",mapToRow(Product.class))
                .saveToCassandra();
        ...
        javaFunctions(salesRDD)
                .writerBuilder("java_api", "sales" , mapToRow(Sale.class))
                .saveToCassandra();
    }
    ...
    public static void main(String[] args) {
        if (args.length != 1) {
            System.out.println("Syntax: org.apache.spark.examples.CassandraDemo <Cassandra contact point>");
        }


        final String cassandraHost = args.length == 1 ? args[0] : "localhost";
